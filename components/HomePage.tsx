...
export default function HomePage({ initialShopCount = 0 }: Readonly<{ initialShopCount?: number }>) {
        ...
        <div className="landing-header-content">
          ...
          <div className="header-box">
            ...
            <ul className="header-menu">
              <li className="data">
                <em>{currentDate}更新</em> メンズエステ求人情報<span>{initialShopCount.toLocaleString()}</span>件掲載
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="area-wrap">
          ...
          <div className="region-section">
            ...
            <div className="topimg wow bounceInDown animated" style={{ visibility: "visible", animationName: "bounceInDown" }}>
              <Image src="/images/topimg_01.png" alt="働きたいエリアを選んでネ" width={400} height={300} />
            </div>
          </div>
        </section>
